...
<%@ page import = "java.sql.ResultSet" %>   
  ...
  <script>
   function preferedBrowser() {
    var a = new String(document.getElementById("create_Rule").value);   
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    <br />
                                       <form id="form_Create_Rule" data-parsley-validate class="form-horizontal form-label-left" action="../controller_UnderWriter" method="post">
										   ...
										   <%
                                                         try{
		                                                       ...
		                                                       ResultSet rs = null;
		                                                                   ...
		                                                                   rs = ps.executeQuery();
                                                %>
                                                                <select id="create_Rule" required="required" class="form-control col-md-7 col-xs-12" rows="3" onchange="preferedBrowser()">
