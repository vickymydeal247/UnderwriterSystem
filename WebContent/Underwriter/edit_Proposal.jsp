...
<%@ page import = "java.sql.ResultSet" %>     
	...
	<script> 
        ...
        function sendInfo()
        {
        	var a = document.getElementById("proposal_Id").value; 
            var url="index.jsp?val="+a;
        ...
        if(request.readyState==4){ 	
         var val=request.responseText;
          //document.write(val); 
		  var a=val.split("!");
          document.getElementById('customer_Id').value = a[0]; 
          document.getElementById("insurance_Type").value = a[1];
          document.getElementById('sum_Insured').value = a[2]; 
          document.getElementById("number_Of_Years").value = a[3];
          document.getElementById('product_Type').value = a[4]; 
          document.getElementById("referred_By").value = a[5];
        //document.write("3");
        }
        }
    </script>  
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    <br /> 
									<form id="form_Edit_Proposal" data-parsley-validate class="form-horizontal form-label-left" action="../controller_UnderWriter">
									<div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="proposal_Id">Select Proposal ID<span class="required">*</span>
											</label>
                                         			 ...
                                         			 <%
                                                         try{
		                                                       ...
		                                                       ResultSet rs = null;
		                                                                   ...
		                                                                   rs = ps.executeQuery();
                                                %>
                                                                 <select id ="proposal_Id" required="required" name="id" class="form-control col-md-7 col-xs-12" rows="3" onChange="sendInfo();preferedBrowser()">
                                                                     <option>Select Proposal ID</option> 
                                                                      <%  while(rs.next()){ %>
	                                   ...
	                                   <div id ="d1" hidden>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="customer_Id" name="customer_Id" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <input type="text" id="insurance_Type" name="insurance_Type" required="required" class="form-control col-md-7 col-xs-12" name="type">
                                                </textarea>
                                            </div>
                                        </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="number" id="sum_Insured" name="sum_Insured" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <span id="amit"> </span>
										<div class="form-group">
										 ...
										 <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="product_Type" name="product_Type" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
										 <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="referred_By" name="referred_By" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                            </div>
                                        </div>
