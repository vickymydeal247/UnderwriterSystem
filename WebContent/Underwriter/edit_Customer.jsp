...
<%@ page import="java.sql.ResultSet"%>  
    ...
    <title>Edit Customer</title>
     ...
     function sendInfo()
     {
         ...
         var url="index_Customer.jsp?val="+a;
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
								 ...
								 <form id="form_Edit_Customer" data-parsley-validate class="form-horizontal form-label-left " action="../controller_UnderWriter">
										...
										<div class="form-group">
                                           ...
                                           <div class="col-md-6 col-sm-6 col-xs-12">
											<select id="customerType" name="ctype" required="required" class="form-control col-md-7 col-xs-12" rows="3" onchange="preferedBrowser()" name="customerType">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="customerName" name="name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Customer Name">
                                            </div>
                                        </div>
										<div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="Occupation" class="radio" ">
                                                    <label class="radio">
                                                        <input class="flat" type="radio" id = "Occupation" name="Occupation" value="miningAndNuclearField"> &nbsp;Mining & Nuclear Field &nbsp;
                                                    </label>
                                                    <label class="radio" >
                                                        <input class="flat" type="radio" id = "Occupation" name="Occupation" value="others" checked=""> Others
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="address" name="add" required="required" class="form-control col-md-7 col-xs-12" rows="3">
                                                </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
