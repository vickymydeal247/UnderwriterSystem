...
function preferedBrowser() {
    var a = new String(document.getElementById("delete_Claim").value);   
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    <br />
									<br /> <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> <span class="required"></span>
                                            </label>
									<div class="col-md-6 col-sm-6 col-xs-12">
									 <select id = "delete_Claim" class="select2_single form-control" tabindex="-1" onchange="preferedBrowser()">
									                <option>Select Claim ID</option>  
												    <option>3</option> 
                                                </select>
                                            </div>
								...
								<br><br>
					<div id ="d1" hidden>
                                    <form id="form_Delete_Claim" data-parsley-validate class="form-horizontal form-label-left">
