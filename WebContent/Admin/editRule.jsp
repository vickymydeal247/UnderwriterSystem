                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
								<form id="form_Edit_Rule" class="form-horizontal form-label-left" data-parsley-validate action="../ControllerServlet">
										   ...
										   <%
                                                         try{
		                                                       ...
		                                                       ResultSet rs = null;
		                                                                   ...
		                                                                   rs = ps.executeQuery();
                                                %>
                                                                <select id="insurance_Type" name="id" required="required" class="form-control col-md-7 col-xs-12" rows="3" onchange="preferedBrowser();sendInfo()">
